...
class EmailSocialLoginMapper:
    ...
    def update_first_login_social_data(self, user: User, data: dict):
    ...
    def update_every_login_social_data(self, user: User, data: dict):
    ...
    def create_blank_user(self, user_model: t.Callable[..., User], dbsession: Session, email: str) -> User:
    ...
    def get_existing_user(self, user_model: t.Callable[..., User], dbsession: Session, email: str) -> User:
    ...
    def get_or_create_user_by_social_medial_email(self, request: Request, user: authomatic.core.User) -> User:
...
class FacebookMapper(EmailSocialLoginMapper):
    ...
    def capture_social_media_user(self, request: Request, result: LoginResult) -> User:
